...
Jms2WinFactory::import( JPATH_COMPONENT,
                        ...
                        array( 'class ContentModelFrontpage'   => 'class ContentModelFrontpageOrig',
                               "JComponentHelper::getParams('com_content')"   => "JComponentHelper::getParams('com_multisitescontent')"
                             )
                      );


class ContentModelFrontpage extends ContentModelFrontpageOrig
{
