...
*/
   ...
   function updateSectionList( site_id, control_name, field_name)
   {
      var ajax;
      var elt;
      ...
      ajax.onreadystatechange  = function()
      {
         if(ajax.readyState  == 4)
         {
            ...
            if(ajax.status  == 200) {
               ...
               // When there is an error or a full html document, the <select statement may be not at the begining of the reply
               // So check the position is < 10
      ...
      ajax.open( "GET", "index.php?option=com_multisitescontent&task=ajaxGetSectionList"
                      + "&site_id="+site_id
