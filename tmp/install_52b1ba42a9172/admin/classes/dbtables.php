 ...
 * - V1.2.64 31-AUG-2011: Add the possibility to get the extension description.
 *                        In joomla 1.6 or 1.7, this allow get the "title" (name) of the extension
 *                        instead of reading all the language files of all the components, modules and plugins.
 */
...
class Jms2WinDBTables
{
   ...
   /**
    * @brief Return the extension description.
    * When an attribute is requested, this return the desription of this attribute.
    */
