 ...
 * - V1.2.53 21-MAY-2011: Fix the update status of a website when the "letter tree" feature is enabled.
 *                        Now read the "multisites.cfg.php" configuration file to take in account of the configuration.
 */
...
class MultisitesUtils
{
   ...
   function updateStatus( $key, $value, $newStatus, $apply2AllSites = false)
   {
      ...
      require_once( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_multisites'.DS. 'models' .DS. 'manage.php');
      @include_once( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_multisites'.DS.'multisites.cfg.php' );
