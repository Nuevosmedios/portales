 ...
 * - V1.2.55 22-JUN-2011: Add variable initialization to avoid notice message displayed when
 *                        loading template from an older version
 * - V1.3.00 05-JUN-2012: Add Geo Localisation, Browser feature
 */
...
class Jms2WinTemplate
{
   ...
   var $redirect1st     = '';       /**< Optional: Redirect to first domain in the list*/
   var $ignoreMasterIndex= '';      /**< Optional: Ignore the creation of the master index */
   ...
   var $continents      = array();  /**< Optional: List of Continent IDs */
   var $countries       = array();  /**< Optional: List of Iso Country Code IDs */
   var $regions         = '';       /**< Optional: List of Region code */
   var $states          = '';       /**< Optional: List of States */
   var $cities          = '';       /**< Optional: List of Cities */
   var $zipcodes        = '';       /**< Optional: List of zipcodes */
   var $fromLongitude   = '';       /**< Optional: from Longitude */
   var $fromLatitude    = '';       /**< Optional: from Latitude */
   var $toLongitude     = '';       /**< Optional: to Longitude */
   var $toLatitude      = '';       /**< Optional: to Latitude */
   var $metro           = '';       /**< Optional: metro code */
   var $area            = '';       /**< Optional: area code */

   var $browser_types   = array();  /**< Optional: browser types */
   var $browser_langs   = '';       /**< Optional: browser language */
   ...
   var $adminUserName   = '';       /**< Optional: New Administrator User Name (full name) that will replace the selected user ID */
   var $adminUserLogin  = '';       /**< Optional: New Administrator User Login that will replace the value in the selected user ID */
   var $adminUserEmail  = '';       /**< Optional: New Administrator email address that will replace the selected User ID */
   var $adminUserPsw    = '';       /**< Optional: New Administrator password that will replace the selected User ID. When equal to {user_psw}, it uses the current logged user password value. */
   ...
   var $setDefaultJLang = '';       /**< Optional: New DB default Joomla Language */
   var $setDefaultTemplate = '';    /**< Optional: New DB default template */
   var $setDefaultMenu  = '';       /**< Optional: New DB default menu */
