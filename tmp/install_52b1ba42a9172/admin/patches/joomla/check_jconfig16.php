 ...
 * - V1.2.81 03-APR-2012: Take in account the Joomla 2.5.4 that move the code into a routine writeConfigFile
 *                        and therefore, there is no more double occurence of the patch
 */
...
OR    \n ...  $configString = $config->toString('PHP', array('class' => 'JConfig', 'closingtag' => false));
   ...
   v2.5.4   begin -> p0 + INSERT PATCH + p6 -> end
