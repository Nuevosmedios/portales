 ...
 * @par History:
 * - V1.1.0 11-MAR-2011: File creation for Joomla 1.6 compatibility
 * - V1.1.7 23-NOV-2012: Fix a bug with Joomla 2.5 when selecting several "featured categories".
 *                       Now read both (merge) the com_content parameters and com_multisitescontent parameters.
 */
...
Jms2WinFactory::import( $jms2win_jpath_component,
                        ...
                        array( 'class ContentModelArticles' => 'class ContentModelArticlesOrig',
                               '$this->getDbo()'            => 'Jms2WinFactory::getMultiSitesDBO()',
                               '$app->getParams();'          => '$app->getParams(\'com_content\'); $params->merge( $app->getParams());'
                             )
                      );

class ContentModelArticles extends ContentModelArticlesOrig
{
