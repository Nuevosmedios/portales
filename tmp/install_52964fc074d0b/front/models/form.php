 ...
 * @par History:
 * - V1.1.0 11-MAR-201: File creation for Joomla 1.6
 */
...
Jms2WinFactory::import( $jms2win_jpath_component,
                        ...
                        array( 'class ContentModelForm'   => 'class ContentModelFormOrig'
                             )
                      );


class ContentModelForm extends ContentModelFormOrig
{
