 ...
 * @par History:
 * - V1.2.69 27-SEP-2011: Ensure that the session is written before closing the session
 */

defined('JPATH_MUTLISITES_COMPONENT') or die( 'Restricted access' );

//------------ jms2win_checkJDatabaseMySQLi ---------------
/**
 * check the patch is present
 */
function jms2win_checkJDatabaseMySQLi( $model, $file)
{
...
//------------ jms2win_actionJDatabaseMySQLi ---------------
/**
 * @brief Install the patch
 */
function jms2win_actionJDatabaseMySQLi( $model, $file)
{
   include_once( dirname(__FILE__) .DS. 'patchloader.php');
   $patchStr = jms2win_loadPatch( 'patch_jdbmysqli.php');
   if ( $patchStr === false) {
      return false;
   }
...
//_jms2win_end
   ...
   */
   ...
   // P1: Search begin statement: "mysqli_close"
   $p1 = strpos( $content, 'mysqli_close');
   if ( $p1 === false) {
      return false;
   }
