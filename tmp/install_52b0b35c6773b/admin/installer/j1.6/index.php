 ...
 * - V1.2.57 07-JUL-2011: Add Joomla 1.6 and 1.7 compatibility
 * - V1.2.71 05-JAN-2012: Add 1.7 compatibility
 */
...
// Include the Joomla 1.7 Controller
jimport('joomla.application.component.controller');
jimport('joomla.client.helper');

$controller	= JController::getInstance( 'MultisitesInstaller',
                                        array( 'default_task' => 'display',
