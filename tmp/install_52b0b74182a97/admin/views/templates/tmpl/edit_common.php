...
<?php if ( !empty( $this->lists['site_ids'])) { ?>
   <tr>
	...
	<tr valign="top" id="admin_username" <?php echo $this->style_showDBFields; ?>>
		<td class="helpMenu">
			<label for="adminUserName">
				<strong><?php echo JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_USERNAME' ); ?>:</strong>
			</label>
		</td>
		<td>
			<input class="inputbox" type="text" name="adminUserName" id="adminUserName" size="50" maxlength="50" value="<?php echo $this->row->adminUserName; ?>" />
			<?php echo JHTML::_('tooltip', JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_USERNAME_TTIPS')); ?>
			<?php echo MultisitesHelper::tooltipsKeywords(); ?>
		</td>
	</tr>
	<tr valign="top" id="admin_login" <?php echo $this->style_showDBFields; ?>>
		<td class="helpMenu">
			<label for="adminUserLogin">
				<strong><?php echo JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_LOGIN' ); ?>:</strong>
			</label>
		</td>
		<td>
			<input class="inputbox" type="text" name="adminUserLogin" id="adminUserLogin" size="50" maxlength="50" value="<?php echo $this->row->adminUserLogin; ?>" />
			<?php echo JHTML::_('tooltip', JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_LOGIN_TTIPS')); ?>
			<?php echo MultisitesHelper::tooltipsKeywords(); ?>
		</td>
	</tr>
	<tr valign="top" id="admin_email" <?php echo $this->style_showDBFields; ?>>
		<td class="helpMenu">
			<label for="adminUserEmail">
				<strong><?php echo JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_EMAIL' ); ?>:</strong>
			</label>
		</td>
		<td>
			<input class="inputbox" type="text" name="adminUserEmail" id="adminUserEmail" size="50" maxlength="50" value="<?php echo $this->row->adminUserEmail; ?>" />
			<?php echo JHTML::_('tooltip', JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_EMAIL_TTIPS')); ?>
			<?php echo MultisitesHelper::tooltipsKeywords(); ?>
		</td>
	</tr>
	<tr valign="top" id="admin_userpsw" <?php echo $this->style_showDBFields; ?>>
		<td class="helpMenu">
			<label for="adminUserPsw">
				<strong><?php echo JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_USERPSW' ); ?>:</strong>
			</label>
		</td>
		<td>
			<input class="inputbox" type="text" name="adminUserPsw" id="adminUserPsw" size="50" maxlength="50" value="<?php echo $this->row->adminUserPsw; ?>" />
			<?php echo JHTML::_('tooltip', JText::_( 'TEMPLATE_VIEW_EDT_CMN_ADMIN_USERPSW_TTIPS')); ?>
			<?php echo MultisitesHelper::tooltipsKeywords(); ?>
		</td>
	</tr>
	...
	<tr valign="top" id="site_name" <?php echo $this->style_showDBFields; ?>>
		<td class="helpMenu">
			<label for="toSiteName">
				<strong><?php echo JText::_( 'TEMPLATE_VIEW_EDT_CMN_TO_SITENAME' ); ?> :</strong>
			</label>
		</td>
		<td>
			<input class="inputbox" type="text" name="toSiteName" id="toSiteName" size="50" maxlength="50" value="<?php echo $this->row->toSiteName; ?>" />
			<?php echo JHTML::_('tooltip', JText::_( 'TEMPLATE_VIEW_EDT_CMN_TO_SITENAME_TTIPS')); ?>
			<?php echo MultisitesHelper::tooltipsKeywords(); ?>
		</td>
	</tr>
<?php } ?>
