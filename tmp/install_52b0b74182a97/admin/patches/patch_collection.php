...
/* History:
   ...
   - 1.2.87 11-JUN-2012 ECH: Add JMS Tools (install) definitions for :
                             ...
                             - Update Listbingo
                             - Preachit
   - 1.2.88 11-AUG-2012 ECH: Add JMS Tools (install) definitions for :
                             - cobalt
                             - ConfigBox
                             - FaLang
                             - JLinked
                             ...
                             - JoomShopping
                             - List Bingo
   - 1.2.89 03-OCT-2012 ECH: Add JMS Tools (install) definitions for :
                             - JooCart
                             - RPL
                             Add Joomla 2.5 sharing definition for:
                             - AwoCoupon
                             - iProperty
                             - VMAffiliate
   - 1.2.90 01-NOV-2012 ECH: Add JMS Tools (install) definitions for :
                             - YooRecipe!
   - 1.2.91 01-NOV-2012 ECH: Add JMS Tools (install) definitions for :
                             - Ohanah
                             - RokSprocket
                             - RSEventsPro
                             Add Joomla 1.5 sharing definition for:
...
if ( version_compare( JVERSION, '2.5') >= 0) {
      ...
      $files2patch = array( 'administrator/components/com_multisites/multisites.xml'   => 'JMSVers',
                            ...
                            'defines.php'                        => 'defines',
                            'includes/defines_multisites.php'    => array( 'ifPresent', 'version'=>'V1.2.65'),
