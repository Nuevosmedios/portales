 ...
 * - V1.2.69 14-NOV-2011: Allow calling this model from any component or model or plugin.
 *                        Replace the JPATH_COMPONENT_ADMINISTRATOR by dirname( dirname( __FILE__))
 * - V1.3.0  09-AUG-2011: Make the "/multisites" directory customizable.
 */
   ...
   function getCurrentRecord()
	{
		if ($this->_template == null) {
			...
			// In case of radio button, this is the "id"
			if ($id = JRequest::getVar('id', false, '', 'string')) {
				$this->_template->load($id);
			}
			// In case of checkbox, this is the cid
			else {
