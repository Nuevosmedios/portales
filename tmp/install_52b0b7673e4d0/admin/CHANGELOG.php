 ...
 *             Single Joomla! 1.5.x, 1.6.x, 1.7.x and 2.5.x installation using multiple configuration (One for each 'slave' sites).
...
-------------------- 1.2.97 [02-dec-2012] ---------------------
- Bundled with Joomla 2.5.8 installation directory.
- Bundled with Patches definition 1.2.91
...
-------------------- 1.2.95 [03-oct-2012] ---------------------
- Fix a bug in joomla 2.5 during the "synchronisation" of the extension isntalled.
...
- Fix the possibility to ignore the "manifest" version when using the parameter MULTISITES_IGNORE_MANIFEST_VERSION
  This feature is helpfull when it is required to upgrade an extension in the slave before the master
  or when an extension has a special installer with another name for an "install bootstrap".
...
-------------------- 1.2.94 [11-aug-2012] ---------------------
- Fix a bug introduced in 1.2.89 concerning the resolution of the table prefix.
  Keyword were no more resolved due to filtering of special characters.
- Bundled with Patches definition 1.2.88
  > Add JMS Tools (install) definitions for :
    - cobalt
    - ConfigBox
    - FaLang
...
-------------------- 1.2.74 [06-feb-2012] ---------------------
- Add rescue registration in the "about us" when our shared hosting provider returns a bad value and interrupt the connection.
...
- Fix a the re-install of a component in a slave site.
...
- Fix the slave site creation when the letter tree is enabled and that the site ID has more
  than 20 characters. In this case, Joomla may report an error when creating the slave site.
  We fixed the website creation to split the site name is block of 10 characters to avoid 
...
- Improve the compatibility with Joomla 1.6.x stable.
  Sometime Joomla 1.6 send a Site ID as an array instead of a string.
