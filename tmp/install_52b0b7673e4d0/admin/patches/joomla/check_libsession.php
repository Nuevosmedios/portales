 ...
 * - V1.2.66 16-AUG-2011: Add patch for Joomla 1.6 and 1.7
 */
...
/**
 * check if 'MULTISITES_COOKIE_SUBDOMAIN' or '//_jms2win' is present
 */
function jms2win_checkLibSession( $model, $file)
{
   ...
   // if 'MULTISITES_COOKIE_DOMAINS' is present
   $pos = strpos( $str, 'MULTISITES_COOKIE_DOMAINS');
   if ($pos === false) {
      // if '//_jms2win' is present
...
//------------ jms2win_actionLibSession15 ---------------
/**
 * @brief Install the patch for Joomla 1.5
 */
...
//------------ jms2win_actionLibSession16 ---------------
/**
 * @brief Install the patch for Joomla 1.6 or 1.7
 */
...
//_jms2win_end
   ...
   */
   ...
   /* ....\n
      ...
      Produce
      begin -> p0 + INSERT PATCH no 1 + p0 -> p5 + INSERT PATCH no 1 + p5 -> end
