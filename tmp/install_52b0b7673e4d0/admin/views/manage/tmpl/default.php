   ...
   @include( dirname( __FILE__).'/default_browser_filter.php');
	...
	<thead>
		<tr>
			...
			<?php } ?>
<?php
if ( JFile::exists( dirname( __FILE__).'/default_geolocalisation_thead.php')) {
   @include( dirname( __FILE__).'/default_geolocalisation_thead.php');
}
if ( JFile::exists( dirname( __FILE__).'/default_browser_thead.php')) {
   @include( dirname( __FILE__).'/default_browser_thead.php');
}
?>
...
?>
         ...
         <?php if ( isset($this->showPassword) && $this->showPassword) { ?>
			...
			<?php } ?>
<?php
if ( JFile::exists( dirname( __FILE__).'/default_geolocalisation_tbody.php')) {
   @include( dirname( __FILE__).'/default_geolocalisation_tbody.php');
}
if ( JFile::exists( dirname( __FILE__).'/default_browser_tbody.php')) {
   @include( dirname( __FILE__).'/default_browser_tbody.php');
}
?>
			<td>
