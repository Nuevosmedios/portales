...
<!--
   ...
   function refreshShareDBStyle( style_display)
   {
      ...
      document.getElementById("tr_divtoSiteName").style.display  = style_display;
   }
...
<?php } ?>
      ...
      document.getElementById("divtoSiteName").innerHTML    = 'Refreshing ...';
...
<?php } ?>
                  ...
                  document.getElementById("divtoSiteName").innerHTML    = strEntryArray[19];
...
<table class="adminform">
	<tr>
		...
		<td>
<?php if ($this->isnew) { ?>
			<input class="inputbox" type="text" name="id" id="id" size="90" maxlength="100" value="<?php echo $this->row->id; ?>" />
...
<?php  if ( version_compare( JVERSION, '1.6') >= 0) {
            ...
            echo '
            <script language="JavaScript" src="'.JURI::root(true).'/administrator/components/com_multisites/libraries/js/joomla.javascript.js" type="text/javascript"></script>
         ...
         ?>
         <input class="inputbox" type="text" name="expiration" id="expiration" size="15" maxlength="12" readonly="true" value="<?php echo $expiration_str; ?>" />
...
<?php } else { ?>
   <tr>
	...
	<tr valign="top" id="tr_divtoSiteName" <?php echo $this->style_shareDB; ?>>
		<td class="helpMenu">
			<label for="divtoSiteName">
				<strong><?php echo JText::_( 'SITE_EDIT_TEMPLATE_TO_SITENAME' ); ?>:</strong>
			</label>
		</td>
		<td>
         <font color="green"><i><div id="divtoSiteName"><?php echo $this->template->toSiteName; ?></div></i></font>
		</td>
	</tr>
