...
?>
	...
	<?php if (!$this->print) : ?>
		...
		<div class="btn-group pull-right btn-article-actions">
			<a class="btn btn-red btn-sm dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-cog"></i> <span class="caret"></span> </a>
