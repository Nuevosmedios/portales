...
<div class="fpssBackendEditPageContainer slideForm<?php echo $this->containerClass; ?>">
		...
		<div class="fpssTabs">
			...
			<div id="fpssSlideMainTab">
				...
				<div class="fpssField">
				    ...
				    <?php if(FPSSHelperExtension::isInstalled('hikashop')): ?>
				    <div class="icon-wrapper">
					    <div class="icon">
						    <a id="source-com_hikashop" class="modal" rel="{handler:'iframe', size: {x: 800, y: 500}}" href="index.php?option=com_fpss&amp;view=extension&amp;task=com_hikashop">
							    <img alt="<?php echo JText::_('FPSS_HIKASHOP_PRODUCT'); ?>" src="components/com_fpss/images/com_hikashop.png" />
							    <span><?php echo JText::_('FPSS_HIKASHOP_PRODUCT'); ?></span>
						    </a>
					    </div>
				    </div>
				    <?php endif; ?>
