/**
 * @version		$Id: fpss.js 3411 2013-07-23 15:05:35Z joomlaworks $
...
function jSelectHikashopProduct(id, title, object){
	$FPSS('#reference').val(title).attr('disabled', 'disabled');
	$FPSS('#referenceType').val('com_hikashop');
	$FPSS('#referenceID').val(id);
	$FPSS('#cpanel .icon a').removeClass('active');
	$FPSS('#source-com_hikashop').addClass('active');
	populateSlide('com_hikashop', id);
	closeModal();
}
