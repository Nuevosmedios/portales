<?php
/**
 * @version		$Id: mod_fpss_stats.php 3411 2013-07-23 15:05:35Z joomlaworks $
...
$document->addScriptDeclaration("
	var FPSSChartData = ".json_encode($chart->data).";
	var FPSSChartCategories = ".json_encode($chart->categories).";
");
$document->addScriptDeclaration("
