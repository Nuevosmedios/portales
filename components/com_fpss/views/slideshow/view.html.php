...
class FPSSViewSlideshow extends FPSSView
{
	...
	function display($tpl = null)
	{
		...
		$heading = (version_compare(JVERSION, '1.6.0', 'ge')) ? $params->get('page_heading', $params->get('page_title')) : $params->get('page_title');
		$this->assignRef('heading', $heading);
		$showHeading = (version_compare(JVERSION, '1.6.0', 'ge')) ? $params->get('show_page_heading') : $params->get('show_page_title');
		$this->assignRef('showHeading', $showHeading);
