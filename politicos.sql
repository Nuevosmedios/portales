...
INSERT INTO `ziax6_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Volcado de datos para la tabla `ziax6_extensions`
--

INSERT INTO `ziax6_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"fb6a203e843d82cc38e92289109e5062"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10001, 'SpanishES', 'language', 'es-ES', '', 0, 1, 0, 0, '{"name":"Spanish (ES)","type":"language","creationDate":"2013-11-6","author":"Spanish Translation Team: Comunidad Joomla","copyright":"Copyright (C) 2005 - 2013 Open Source Matters and comunidadjoomla.org. All rights reserved.","authorEmail":"info@comunidadjoomla.org","authorUrl":"www.comunidadjoomla.org","version":"3.2.0.1","description":"Spanish language pack for Joomla! 3.2.0 - Site","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'SpanishES', 'language', 'es-ES', '', 1, 1, 0, 0, '{"name":"Spanish (ES)","type":"language","creationDate":"2013-11-6","author":"Spanish Translation Team: Comunidad Joomla","copyright":"Copyright (C) 2005 - 2013 Open Source Matters and comunidadjoomla.org. All rights reserved.","authorEmail":"info@comunidadjoomla.org","authorUrl":"www.comunidadjoomla.org","version":"3.2.0.1","description":"Spanish language pack for Joomla! 3.2.0 - Administrator","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 'es-ES', 'package', 'pkg_es-ES', '', 0, 1, 1, 0, '{"name":"Spanish Language Pack","type":"package","creationDate":"6 de noviembre del 2013","author":"Spanish Translation Team: comunidadjoomla.org","copyright":"Copyright (C) 2005 - 2013 comunidadjoomla.org and Open Source Matters. All rights reserved.","authorEmail":"info@comunidadjoomla.org","authorUrl":"www.comunidadjoomla.org","version":"3.2.0.1","description":"\\n\\t\\t<div style=\\"text-align:left;\\">\\n\\t\\t<h2>Successfully installed the spanish language pack for Joomla! 3.2.0.<\\/h2>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Please report any bugs or issues at the Comunidad Joomla! <a href=\\"http:\\/\\/foro.comunidadjoomla.org\\/traduccion-ext\\/\\" target=\\"_blank\\">Translation forum<\\/a><\\/p>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Translated by: <a href=\\"http:\\/\\/www.comunidadjoomla.org\\" target=\\"_blank\\" title=\\"\\">The spanish translation team of Comunidad Joomla!<\\/a><\\/p>\\n\\t\\t<h2>El paquete en espa\\u00f1ol para Joomla! 3.2.0 se ha instalado correctamente.<\\/h2>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Por favor, reporte cualquier bug o asunto relacionado a nuestro <a href=\\"http:\\/\\/foro.comunidadjoomla.org\\/traduccion-ext\\/\\" target=\\"_blank\\">Foro de traducciones<\\/a><\\/p>\\n\\t\\t<p><\\/p>\\n\\t\\t<p>Traducci\\u00f3n: <a href=\\"http:\\/\\/www.comunidadjoomla.org\\" target=\\"_blank\\" title=\\"\\">El equipo de traducci\\u00f3n de Comunidad Joomla!<\\/a><\\/p>\\n\\t\\t<\\/div>\\n\\t\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10004, 'politicos', 'template', 'politicos', '', 0, 1, 1, 0, '{"name":"politicos","type":"template","creationDate":"18\\/12\\/2013","author":"nuevosmedios","copyright":"Copyright (C) 2013 Open Source Matters, Inc. Todos los derechos reservados.","authorEmail":"pablo.pantoja@nuevosmedios.ws","authorUrl":"","version":"1.0","description":"Template for Pol\\u00edticos (Partido de la U)","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10005, 'plg_editors_jce', 'plugin', 'jce', 'editors', 0, 1, 1, 0, '{"name":"plg_editors_jce","type":"plugin","creationDate":"12 December 2013","author":"Ryan Demmer","copyright":"2006-2010 Ryan Demmer","authorEmail":"info@joomlacontenteditor.net","authorUrl":"http:\\/\\/www.joomlacontenteditor.net","version":"2.3.4.4","description":"WF_EDITOR_PLUGIN_DESC","group":""}', '{"verify_html":"0","schema":"html4","entity_encoding":"raw","keep_nbsp":"1","cleanup_pluginmode":"0","forced_root_block":"0","content_style_reset":"0","content_css":"1","content_css_custom":"","body_class":"","compress_javascript":"0","compress_css":"0","compress_gzip":"0","use_cookies":"1","custom_config":"","callback_file":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Volcado de datos para la tabla `ziax6_finder_taxonomy`
--

INSERT INTO `ziax6_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);
...
--
-- Volcado de datos para la tabla `ziax6_finder_terms_common`
--

INSERT INTO `ziax6_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Volcado de datos para la tabla `ziax6_languages`
--

INSERT INTO `ziax6_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Volcado de datos para la tabla `ziax6_menu_types`
--

INSERT INTO `ziax6_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
INSERT INTO `ziax6_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Main Menu', '', '', 1, 'menu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 0, '{"menutype":"candidato","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
--
-- Volcado de datos para la tabla `ziax6_modules_menu`
--

INSERT INTO `ziax6_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
INSERT INTO `ziax6_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Volcado de datos para la tabla `ziax6_schemas`
--

INSERT INTO `ziax6_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.1');
...
--
-- Volcado de datos para la tabla `ziax6_session`
--
...
--
-- Volcado de datos para la tabla `ziax6_tags`
--

INSERT INTO `ziax6_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
...
--
-- Volcado de datos para la tabla `ziax6_template_styles`
--

INSERT INTO `ziax6_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'politicos', 0, '1', 'politicos - Defecto', '{}');
...
--
-- Volcado de datos para la tabla `ziax6_update_sites`
--
...
--
-- Volcado de datos para la tabla `ziax6_update_sites_extensions`
--

INSERT INTO `ziax6_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 10000),
...
--
-- Volcado de datos para la tabla `ziax6_usergroups`
--

INSERT INTO `ziax6_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Volcado de datos para la tabla `ziax6_user_usergroup_map`
--
...
--
-- Volcado de datos para la tabla `ziax6_viewlevels`
--

INSERT INTO `ziax6_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Volcado de datos para la tabla `ziax6_wf_profiles`
--

INSERT INTO `ziax6_wf_profiles` (`id`, `name`, `description`, `users`, `types`, `components`, `area`, `device`, `rows`, `plugins`, `published`, `ordering`, `checked_out`, `checked_out_time`, `params`) VALUES
(1, 'Default', 'Default Profile for all users', '', '6,7,3,4,5,8', '', 2, 'desktop,tablet,phone', 'help,newdocument,undo,redo,spacer,bold,italic,underline,strikethrough,justifyfull,justifycenter,justifyleft,justifyright,spacer,blockquote,formatselect,styleselect,removeformat,cleanup;fontselect,fontsizeselect,forecolor,backcolor,spacer,clipboard,indent,outdent,lists,sub,sup,textcase,charmap,hr;directionality,fullscreen,preview,source,print,searchreplace,spacer,table;visualaid,visualchars,visualblocks,nonbreaking,style,xhtmlxtras,anchor,unlink,link,imgmanager,spellchecker,article', 'charmap,contextmenu,browser,inlinepopups,media,help,clipboard,searchreplace,directionality,fullscreen,preview,source,table,textcase,print,style,nonbreaking,visualchars,visualblocks,xhtmlxtras,imgmanager,anchor,link,spellchecker,article,lists', 1, 1, 0, '0000-00-00 00:00:00', '{"editor":{"allow_javascript":"1","allow_css":"1","allow_php":"1"},"media":{"iframes":"1"}}'),
